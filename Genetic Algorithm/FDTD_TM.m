function [efficiency,Ez_Excitation,Ez_Probe] = FDTD_TM(permittivity,enableAnimate)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%    Ez(32:114,L+10) = -flipud(Ez(138:220,L+10));
   ...
   if(n>4000 && enableAnimate && mod(n,10)==0)
       pcolor(X,Y,Ez);
       ...
       rectangle('Position',[1200e-9,-940e-9,1300e-9,440e-9]);
       rectangle('Position',[1200e-9,500e-9,1300e-9,440e-9]);
       caxis([-0.3 0.3])
       shading interp
       pause(0.01);
   end
