...
%    Ez(32:114,L+10) = -flipud(Ez(138:220,L+10));
   ...
   Ez(127:137,L+10) = exp(-1.236*2.2)/cos(0.5299*2.2)*cos(5.299e6*(1:11)*dy)*cos(w0*n*dt);
   Ez(126,L+10) = exp(-1.236*2.2)/cos(0.5299*2.2)*cos(w0*n*dt);
   Ez(115:125,L+10) = flipud(Ez(127:137,L+10));
   Ez(138:220,L+10) = exp(-1.236*1e7*dy*(12:94))*cos(w0*n*dt);
   Ez(32:114,L+10) = flipud(Ez(138:220,L+10));
   %%%%%
